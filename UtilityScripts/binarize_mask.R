...
nii_mask_nonbin  <- readNIfTI("/rat_templates/SIGMA_Rat_Anatomical_Imaging/SIGMA_Rat_Anatomical_InVivo_Template/anatomy/SIGMA_InVivo_Anatomical_Brain_csf.nii.gz",
                               ,reorient = FALSE)
